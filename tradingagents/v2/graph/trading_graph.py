...
from tradingagents.v2.agents import *
from tradingagents.default_config import DEFAULT_CONFIG
from tradingagents.v2.agents.utils.memory import FinancialSituationMemory
from tradingagents.v2.agents.utils.agent_states import (
    AgentState,
    InvestDebateState,
    RiskDebateState,
)
from tradingagents.v2.dataflows.interface import set_config
from tradingagents.v2.infrastructure.external import build_default_gateway
...
class TradingAgentsGraph:
    ...
    def propagate(self, company_name, trade_date):
        ...
        version = (self.config.get("runtime_version") or "v1").lower()
